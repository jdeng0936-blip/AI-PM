...
class Notification(BaseMixin, Base):
    ...
    template: Mapped[NotificationTemplate] = mapped_column(Enum(NotificationTemplate), nullable=False, index=True)
    ...
    def __repr__(self) -> str:
        return f"<Notification channel={self.channel} template={self.template} status={self.status}>"
